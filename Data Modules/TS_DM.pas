...
//    RegKey.WriteBool('Highlight Lookup Search Match', cbxHighlightSearchMatch.Checked);
  ...
  TTSDM = class(TVBBaseDM)
    ...
    cdsViewDirector: TFDMemTable;
    dtsViewDirector: TDataSource;
    cdsViewDirectorID: TIntegerField;
    cdsViewDirectorCUSTOMER_ID: TIntegerField;
    cdsViewDirectorSALUTATION_ID: TIntegerField;
    cdsViewDirectorSALUTATION: TStringField;
    cdsViewDirectorFIRST_NAME: TStringField;
    cdsViewDirectorLAST_NAME: TStringField;
    cdsViewDirectorTAX_NO: TStringField;
    cdsViewDirectorMOBILE_PHONE: TStringField;
    cdsViewDirectorEMAIL_ADDRESS: TStringField;
    ...
    cdsDirectorFIRST_NAME: TWideStringField;
    cdsDirectorLAST_NAME: TWideStringField;
    cdsDirectorTAX_NO: TWideStringField;
    cdsDirectorMOBILE_PHONE: TWideStringField;
    cdsDirectorEMAIL_ADDRESS: TWideStringField;
    cdsDirectorID_NUMBER: TWideStringField;
    cdsShareholderID: TIntegerField;
    cdsShareholderCUSTOMER_ID: TIntegerField;
    cdsShareholderSALUTATION_ID: TIntegerField;
    cdsShareholderFIRST_NAME: TWideStringField;
    cdsShareholderLAST_NAME: TWideStringField;
    cdsShareholderMOBILE_PHONE: TWideStringField;
    cdsShareholderEMAIL_ADDRESS: TWideStringField;
    cdsShareholderPERCENT_SHARE: TSingleField;
    cdsShareholderID_NUMBER: TWideStringField;
    ...
    procedure cdsTimesheetBeforeDelete(DataSet: TDataSet);
  private
...
begin
//  DecodeDate(cdsTimesheet.FieldByName('ACTIVITY_DATE').AsDateTime, AYear, AMonth, ADay);
//  cdsTimesheet.FieldByName('THE_PERIOD').AsInteger := AYear * 100 + AMonth;
//
//  // Set ITEM_VALUE
...
begin
  {Note to devleoper.
   ...
   These fiedls are calculated in the DB itself. If you set these values here
