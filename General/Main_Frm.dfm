inherited MainFrm: TMainFrm
  ...
  inherited actList: TActionList
    ...
    object actApprove: TAction
      ...
      Caption = 'Approve'
      ImageIndex = 29
      OnExecute = DoTogleApprovalStatus
    end
  ...
  object repScreenTip: TdxScreenTipRepository
    ...
    object tipApprove: TdxScreenTip
      Header.Text = 'Approve'
      Description.Text = 'Change approval status of selected timesheet item(s)'
      Width = 350
    end
    object tipBillable: TdxScreenTip
      Header.Text = 'Billable'
      Description.Text = 'Cange billable status of selected timesheet item(s)'
      Width = 350
    end
  end
