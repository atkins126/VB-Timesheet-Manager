inherited MonthlyBillableReportFrm: TMonthlyBillableReportFrm
  ...
  inherited layMain: TdxLayoutControl
    ...
    object grdMonthlyBilling: TcxGrid [3]
      ...
      object viewMonthlyBilling: TcxGridDBBandedTableView
        ...
        DataController.DataSource = ReportDM.dtsMonthlyBilling
        ...
        object edtYear: TcxGridDBBandedColumn
        ...
        object edtMonth: TcxGridDBBandedColumn
          DataBinding.FieldName = 'THE_MONTH'
        ...
        object edtCarryForward: TcxGridDBBandedColumn
        ...
        object edtBillableHours: TcxGridDBBandedColumn
          DataBinding.FieldName = 'TOTAL_HOURS_BILLABLE'
          PropertiesClassName = 'TcxCurrencyEditProperties'
          Properties.DisplayFormat = '#,##0.00'
          Properties.EditFormat = '#,##0.00'
          Properties.ReadOnly = True
      ...
      object lvlMonthlyBilling: TcxGridLevel
        GridView = viewMonthlyBilling
      end
    end
    object lucSelectBy: TcxComboBox [4]
      Left = 71
      Top = 71
      Properties.DropDownListStyle = lsFixedList
      Properties.ImmediatePost = True
      Properties.Items.Strings = (
        ...
        'Year')
      Properties.PostPopupValueOnTab = True
      Properties.OnChange = lucSelectByPropertiesChange
      Style.HotTrack = False
      Style.TransparentBorder = False
      TabOrder = 1
      Width = 70
    ...
    object grpGetOptions: TdxLayoutGroup
      Parent = layMainGroup_Root
    ...
    object litGrid: TdxLayoutItem
      ...
      AlignVert = avClient
      CaptionOptions.Visible = False
      Control = grdMonthlyBilling
      ControlOptions.OriginalHeight = 200
      ControlOptions.OriginalWidth = 510
      ControlOptions.ShowBorder = False
      Index = 2
    end
    object litSelectBy: TdxLayoutItem
      Parent = grpGetOptions
      CaptionOptions.Text = 'Select By'
      Control = lucSelectBy
      ControlOptions.OriginalHeight = 19
